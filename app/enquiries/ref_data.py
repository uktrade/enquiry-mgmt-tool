...
class PrimarySector(Choices):
    ...
    AGRICULTURE = ("AGRICULTURE,", "Agriculture, Horticulture, Fisheries and Pets")
    AIRPORTS = ("AIRPORTS", "Airports")
    AUTOMOTIVE = ("AUTOMOTIVE", "Automotive")
    CHEMICALS = ("CHEMICALS", "Chemicals")
    CONSTRUCTION = ("CONSTRUCTION", "Construction")
    CONSUMER = ("CONSUMER", "Consumer and Retail")
    ...
    FINANCIAL = ("FINANCIAL", "Financial and Professional Services")
    FOOD = ("FOOD", "Food and Drink")
    HEALTHCARE = ("HEALTHCARE", "Healthcare Services")
    MARITIME = ("MARITIME", "Maritime")
    MEDICAL = ("MEDICAL", "Medical Devices and Equipment")
    MINING = ("MINING", "Mining")
    PHARMACEUTICALS = ("PHARMACEUTICALS", "Pharmaceuticals and Biotechnology")
    RAILWAYS = ("RAILWAYS", "Railways")
    SECURITY = ("SECURITY", "Security")
    SPACE = ("SPACE", "Space")
    SPORTS = ("SPORTS", "Sports Economy")
    TECHNOLOGY = ("TECHNOLOGY", "Technology and Smart Cities")
    WATER = ("WATER", "Water")
...
class Country(Choices):
    ...
    CONGO = ("CONGO", "Congo")
    CONGO_DR = ("CONGO_DR", "Congo (Democratic Republic)")
